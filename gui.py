...
class Hyperelastic_curve_fit:
    def __init__(self, top=None):
        ...
        self.EntryFilename.place(relx=0.19, rely=0.04,height=24, relwidth=0.39)
        ...
        self.ButtonProcess.place(relx=0.04, rely=0.27, height=26, width=466)
        ...
        self.ButtonProcess.configure(width=466)

        self.FramePlot = Frame(top)
        self.FramePlot.place(relx=0.04, rely=0.36, relheight=0.46, relwidth=0.89)
        ...
        self.EntrySamples.place(relx=0.19, rely=0.11,height=24, relwidth=0.39)
        ...
        self.Label2.place(relx=0.04, rely=0.11, height=26, width=65)
        ...
        self.FrameNavigation.place(relx=0.04, rely=0.85, relheight=0.08
                , relwidth=0.89)
        ...
        self.Label3.place(relx=0.04, rely=0.18, height=26, width=71)
        ...
        self.EntryDelimiter.place(relx=0.19, rely=0.18, height=24, relwidth=0.39)
        ...
        self.EntryDelimiter.configure(width=204)

        self.RadiobuttonUT = Radiobutton(top)
        self.RadiobuttonUT.place(relx=0.61, rely=0.04, relheight=0.07
                , relwidth=0.26)
        ...
        self.RadiobuttonET.place(relx=0.61, rely=0.11, relheight=0.07
                , relwidth=0.3)
        ...
        self.RadiobuttonPS.place(relx=0.61, rely=0.18, relheight=0.07
                , relwidth=0.19)
