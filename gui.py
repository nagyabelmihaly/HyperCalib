...
class Hyperelastic_curve_fit:
    def __init__(self, top=None):
        ...
        self.TComboboxModel.place(relx=0.08, rely=0.32, relheight=0.05
                , relwidth=0.41)
        READONLY = 'readonly'
        self.TComboboxModel.configure(state=READONLY)
        self.TComboboxModel.configure(width=407)
        self.TComboboxModel.configure(takefocus="")

        self.Label5 = Label(top)
        self.Label5.place(relx=0.02, rely=0.32, height=26, width=52)
