...
class Hyperelastic_curve_fit:
    def __init__(self, top=None):
        ...
        self.EntryRounds.configure(highlightbackground="#d9d9d9")
        self.EntryRounds.configure(highlightcolor="black")
        self.EntryRounds.configure(insertbackground="black")
        self.EntryRounds.configure(selectbackground="#c4c4c4")
        self.EntryRounds.configure(selectforeground="black")
