...
class Ogden3:
    ...
    def ut(self, stretch, mu1, mu2, mu3, alpha1, alpha2, alpha3):
        ...
        return 2 * mu1 / alpha1 * (power(stretch, alpha1) - power(stretch, -0.5 * alpha1)) \
             ...
             + 2 * mu3 / alpha3 * (power(stretch, alpha3) - power(stretch, -0.5 * alpha3))
    ...
    def et(self, stretch, mu1, mu2, mu3, alpha1, alpha2, alpha3):
        ...
        return 2 * mu1 / alpha1 * (power(stretch, alpha1) - power(stretch, -2 * alpha1)) \
             ...
             + 2 * mu3 / alpha3 * (power(stretch, alpha3) - power(stretch, -2 * alpha3))
    ...
    def ps(self, stretch, mu1, mu2, mu3, alpha1, alpha2, alpha3):
        ...
        return 2 * mu1 / alpha1 * (power(stretch, alpha1) - power(stretch, -alpha1)) \
             ...
             + 2 * mu3 / alpha3 * (power(stretch, alpha3) - power(stretch, -alpha3))
